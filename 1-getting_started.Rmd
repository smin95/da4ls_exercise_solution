...
### The Whole Book {-}
I have had a difficulty in finding a statistics book with R that has so many exercises, except for this one. After doing this book, I no longer found statistical tests (ex. t-test, ANOVA, etc) as a black box anymore. The book seems to be good as a prerequisite before diving into machine learning.
